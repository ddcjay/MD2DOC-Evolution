          ...
          {items.map((item, index) => {
            ...
            return (
              <button
                ...
                `}
                style={isSelected ? { color: 'var(--product-primary)' } : {}}
              >
                <div
                  className={`
                  ...
                  `}
                  style={isSelected ? { borderColor: 'var(--product-primary)' } : {}}
                >
                  <Icon className="w-4 h-4" style={isSelected ? { color: 'var(--product-primary)' } : {}} />
                </div>
