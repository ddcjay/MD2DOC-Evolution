    ...
    case BlockType.CHAT_CUSTOM:
      ...
      return (
        <div className={`flex ${isRight ? 'justify-end pl-20' : isCenter ? 'justify-center px-10' : 'justify-start pr-20'} my-12`}>
          ...
          `}>
            <div 
              className={`absolute -top-3 ${isRight ? 'left-4' : isCenter ? 'left-1/2 -translate-x-1/2' : 'right-4'} bg-inherit px-2 text-[10px] font-black tracking-widest border border-slate-200 dark:border-slate-700 uppercase`}
